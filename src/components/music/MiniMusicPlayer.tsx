...
export const MiniMusicPlayer: React.FC = () => {
  ...
  if (isMinimized) {
    return (
      <div className="fixed bottom-20 md:bottom-4 right-3 z-30 flex items-center gap-1.5 animate-in fade-in zoom-in duration-200">
        <button
          type="button"
          onClick={() => {
            soundFx.playPop();
  ...
  return (
    <div
      ...
      className="fixed bottom-20 md:bottom-4 right-3 z-30 flex items-center gap-2 bg-slate-900/95 backdrop-blur-md text-white px-3 py-2 rounded-2xl border border-pink-500/30 shadow-xl shadow-pink-950/20 max-w-[280px] sm:max-w-[320px] transition-all animate-in fade-in zoom-in duration-200"
    >
